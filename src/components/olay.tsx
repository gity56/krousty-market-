...
const Button = () => {
  return (
    <StyledWrapper>
      ...
      <div className="comic-brutal-button-container -mt-12 justify">
        <div className="logo-container">
            <img src="./market.png" className='logo-image' alt="logo" />
        </div>
        <button className="comic-brutal-button">
          <div className="button-inner">
            <span className="button-text">GANGNEZ MTN!</span>
...
const StyledWrapper = styled.div`
  ...
  .logo-container {
    position: relative;
    animation: logo-float 3s ease-in-out infinite, logo-rotate 6s linear infinite;
  }
  ...
  .button-inner {
    ...
    animation: skew-pulse 2s ease-in-out infinite;
  }
  ...
  .ink-splatter {
    ...
    animation: splatter-pulse 2s ease-in-out infinite;
  }
  ...
  @keyframes logo-glow {
    0%, 100% {
      filter: drop-shadow(0 0 20px rgba(255, 61, 61, 0.5));
    }
    50% {
      filter: drop-shadow(0 0 40px rgba(61, 61, 255, 0.8));
    }
  }
